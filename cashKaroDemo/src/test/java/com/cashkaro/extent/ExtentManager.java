...
import com.relevantcodes.extentreports.ExtentReports;
	...
	public class ExtentManager {
		...
		public static String reportPath = System.getProperty("user.dir") + "\\src\\test\\java\\com\\cashkaro\\screenshot\\Report.html";
		...
		public static ExtentReports  getInstances(){
			...
			if (extent == null){
				...
				extent.loadConfig(new File(System.getProperty("user.dir")+"\\src\\test\\java\\com\\cashkaro\\extent\\extent-config.xml"));
